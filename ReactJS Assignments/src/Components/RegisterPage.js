...
function RegisterPage() {
    const initialValues = {firstName:'Rohith', lastName:'', username:'', email:'', phoneNumber:'', password:'', confirmPassword:''}
                ...
                <Col>
                    <form onSubmit={registerFormHandler}>
                        <Form.Group className='register-form'>
                            ...
                            <Link to='/'>
                                <button type='submit' className='go-back-button'>Go Back</button>
                            </Link>
