...
import './TitleInfoDetails.css'


function TitleInfoDetails() {
    const [articles,setArticles] = useState([])
    const titleInfoName=sessionStorage.getItem('titleInfoName')
    ...
    useEffect(() =>{
        axios.get('https://newsapi.org/v2/everything?q=tesla&from=2021-12-12&sortBy=publishedAt&apiKey=31e92b13ac7b4a93a3891f0daa8df7be')
        .then(res =>{
...
export default TitleInfoDetails
